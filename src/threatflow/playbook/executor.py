...
Runs a validated :class:`~threatflow.playbook.models.Playbook` step by step,
...
from threatflow.core.executor import ActionExecutor, ApprovalRequired
from threatflow.core.models import ExecutionResult
from threatflow.playbook.models import OnError, Playbook, PlaybookStep
...
class PlaybookExecutor:
    """
    Executes a :class:`~threatflow.playbook.models.Playbook` using an
    :class:`~threatflow.core.executor.ActionExecutor`.
    ...
    Args:
        executor: Configured :class:`~threatflow.core.executor.ActionExecutor`.
    """
