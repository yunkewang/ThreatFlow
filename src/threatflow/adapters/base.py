...
class NativeActionMapping:
    """
    Describes how an abstract ThreatFlow action maps to a provider-native
...
class BaseAdapter(ABC):
    """
    Abstract base class for all ThreatFlow provider adapters.
    ...
    def provider_info(self) -> ProviderInfo:
        ...
        Returns:
            :class:`~threatflow.core.models.ProviderInfo` describing the adapter.
        """
    ...
    def execute(self, action: Action, params: dict[str, Any]) -> ExecutionResult:
        ...
        :class:`~threatflow.core.models.ExecutionResult` rather than raising.
        ...
        Returns:
            :class:`~threatflow.core.models.ExecutionResult`.
        """
    ...
    def dry_run(self, action: Action, params: dict[str, Any]) -> ExecutionResult:
        ...
        Returns:
            :class:`~threatflow.core.models.ExecutionResult` with ``dry_run=True``.
        """
