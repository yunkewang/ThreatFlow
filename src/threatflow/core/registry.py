...
class ActionRegistry:
    ...
    Typically populated by :class:`~threatflow.core.loader.CatalogLoader`
    ...
    def register(self, action: Action) -> None:
        ...
        Args:
            action: The :class:`~threatflow.core.models.Action` to register.
        """
    ...
    def filter(
        ...
        *,
        ...
        Returns:
            Sorted list of matching :class:`~threatflow.core.models.Action`.
        """
        results: list[Action] = []
