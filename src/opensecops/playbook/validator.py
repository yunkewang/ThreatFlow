...
without executing any actions. Used by ``opensecops playbook validate``.
"""
...
from opensecops.playbook.models import Playbook, PlaybookStep
...
class PlaybookValidator:
    ...
    Args:
        registry: Populated :class:`~opensecops.core.registry.ActionRegistry`.
    """
    ...
    def validate_file(self, path: Path | str) -> Playbook:
        ...
        Returns:
            Validated :class:`~opensecops.playbook.models.Playbook`.
