"""
CLI sub-commands: ``opensecops playbook``

    opensecops playbook validate <file>
    opensecops playbook run <file> --inputs <json_file> [--dry-run] [--force]
"""
...
from opensecops.playbook.executor import PlaybookExecutor, PlaybookRunResult, StepStatus
...
def playbook_run(
    ...
    Examples::
        ...
        opensecops playbook run playbooks/phishing_response.yaml \\
